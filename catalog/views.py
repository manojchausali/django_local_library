...
def index(request):
    ...
    num_bookswithword=Book.objects.filter(title__icontains='point').count()
    ...
    return render(
        ...
        'num_bookswithword':num_bookswithword,'num_visits':num_visits},
    )
...
class LibrarianAccess(LoginRequiredMixin,generic.ListView):
    model = BookInstance
    permission_required='catalog.can_mark_returned'
    template_name='catalog/Librarians_Access.html'
